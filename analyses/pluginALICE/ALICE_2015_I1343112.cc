...
namespace Rivet {
  ...
  public:
    ...
    void analyze(const Event& event) 
	{
		...
		if (c >= 10 && c <= 30) {
			_eventcounter3++; //counts the number of events within this centrality
	...
	//decalring the number of collions counter for differnet centralities 
	double _ncollc1 = 1501;
	double _ncollc3 = 743;
	//decalring the divide function 
